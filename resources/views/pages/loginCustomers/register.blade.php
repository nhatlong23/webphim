			...
			<div class="fxt-bg-color">
				<div class="fxt-header">
					...
					<div class="fxt-page-switcher">
						...
						<a href="{{ route('redirectToRegister') }}" class="switcher-text switcher-text2 active">Đăng ký</a>
					</div>
				</div>
				<div class="fxt-form">
					@if ($errors->any())
					...
					<form method="POST" action="{{ route('RegisterCustomer') }}">
						...
						<div class="form-group fxt-transformY-50 fxt-transition-delay-1">
							<input type="text" class="form-control" name="name" placeholder="Tên" required="required" value="{{ old('name') }}">
							<i class="flaticon-user"></i>
						</div>
						<div class="form-group fxt-transformY-50 fxt-transition-delay-2">
							<input type="email" class="form-control" name="email" placeholder="Nhập email" required="required" value="{{ old('email') }}">
                        ...
                        <div class="form-group fxt-transformY-50 fxt-transition-delay-3">
							<input type="password" class="form-control" name="check-password" placeholder="Nhập lại password" required="required">
							<i class="flaticon-padlock"></i>
						</div>
